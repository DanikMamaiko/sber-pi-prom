...
def test_server_total_effort_is_finite_sum_rounded_to_three_decimals():
    ...
    # The primary row belongs to the board owner and is independent of the task owner.
    # A second row can only exist in legacy data and is ignored.
