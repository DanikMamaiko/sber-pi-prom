...
При включённой отправке аудита в QRadar используйте также `-f docker-compose.siem.yml`
при обновлении/пересоздании API. Подготовка каталога, конфигурация rsyslog и проверка
доставки описаны в [docs/siem.md](docs/siem.md).
