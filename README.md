...
В MVP реализованы тестовая парольная авторизация, часовая `HttpOnly` cookie-сессия,
ролевая модель доступа и read-only импорт Epic из Jira SW IFT. LDAP/Active Directory
остаётся будущим расширением.
